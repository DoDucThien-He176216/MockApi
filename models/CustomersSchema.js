...
const CustomersSchema = new Schema({
  ...
  Liabilities: { type: Schema.Types.Decimal128 },// cong no
  ...
  Accounts_receivable: { type: String, enum: ['131'] },//Tk cong no phai thu 
  ...
  Role: { type: String, enum: ['organization', 'individual'] },
