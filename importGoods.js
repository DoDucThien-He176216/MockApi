...
const Customer = require("./models/Misa_CustomersSchema"); // Import Schema
const fs = require("fs");
const BanksSchema = require("./models/MiSa_BanksSchema");
const GoodsSchema = require("./models/MiSa_GoodsSchema");
